...
/**
 ...
 Something Triple Glyph Test

 ...I know, its a stupid name.
 */

@Autonomous(name="BlueOneTrippleGlyph", group ="Autonomous")
//@Disabled
public class NotGonna_WorkB extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("version: ", "10.5 |  Blue side right column!!!!!!!!!");
        telemetry.update();
        waitForStart();
...
*/
              ...
              /*  GlyphWheels.setPower(.6);
                ...
                while (Math.abs(leftFront.getCurrentPosition()) < 900 && opModeIsActive()) {
                    telemetry.addData("Encoder Count", leftFront.getCurrentPosition());
                    angles = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
                }
                leftFront.setPower(0);
...
*/
                ...
                rightFront.setPower(.6);
                rightRear.setPower(.6);
                while (Math.abs(leftFront.getCurrentPosition()) < 2000 && opModeIsActive()) {
                    telemetry.addData("Encoder Count", leftFront.getCurrentPosition());
                    angles = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
                    if (blockDetected) {
                        GlyphWheels.setPower(0);
