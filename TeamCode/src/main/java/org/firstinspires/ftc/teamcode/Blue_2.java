...
@Autonomous(name="Worlds_Blue_2", group ="Autonomous")
//@Disabled
   ...
   // private DistanceSensor Range;
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // GlyphSlide = (hardwareMap.dcMotor.get("slide"));
        ...
        telemetry.addData("version: ", "Left Side 4.00 | 'The Magic Number' Edition!");
        telemetry.update();
        waitForStart();
        encReset();
        ...
        while (Math.abs(encoderCount + 1800) > Math.abs(leftFront.getCurrentPosition()) && opModeIsActive()) {
        ...
        if (left == true && glyphBoxRan == false) {
            glyphBoxRan = true;
            while (!cryptobox && opModeIsActive()) {
                ...
                while (blueTouch.getState() && opModeIsActive()) {
                    ...
                    rightFront.setPower(.23);
                    rightRear.setPower(.23);
                }
                cryptobox = true;
            }
            ...
            rightFront.setPower(.20);
            rightRear.setPower(0.20);
            while (Math.abs(leftFront.getCurrentPosition()) < 225 && opModeIsActive()) {
                telemetry.addData("Encoder Count", leftFront.getCurrentPosition());
                telemetry.update();
            }
            leftFront.setPower(0);
...
*/
            ...
            while (angles.firstAngle > 5 && opModeIsActive()) {
            ...
            rightFront.setPower(.20);
            rightRear.setPower(0.20);
            while (Math.abs(leftFront.getCurrentPosition()) < 950 && opModeIsActive()) {
                telemetry.addData("Encoder Count", leftFront.getCurrentPosition());
                telemetry.update();
            }
            leftFront.setPower(0);
        ...
        } else if (right == true && glyphBoxRan == false) {
            glyphBoxRan = true;
            while (!cryptobox && opModeIsActive() || timeout + 1000 > runtime.milliseconds()) {
                tss.setPosition(.4);
                sleep(250);
            ...
            rightRear.setPower(.2);
            while (Math.abs(leftFront.getCurrentPosition()) < 1525 && opModeIsActive()) {
                telemetry.addData("Encoder Count", leftFront.getCurrentPosition());
                telemetry.update();
            }
            leftFront.setPower(0);
