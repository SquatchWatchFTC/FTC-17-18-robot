...
@Autonomous(name="Relic_Red_two", group ="Autonomous")
@Disabled
public class Red_two extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!vuforiaHasRan && opModeIsActive() && timeout + 5000 > runtime.milliseconds()) {
            ...
            if (vuMark.equals(RelicRecoveryVuMark.RIGHT)) {
                ...
                while (Math.abs(leftmotor.getCurrentPosition()) < 1700) {
                    telemetry.addData("Encoder Count", leftmotor.getCurrentPosition());
                    telemetry.update();
                }
                leftmotor.setPower(0);
                ...
                while (Math.abs(leftmotor.getCurrentPosition()) <950) {
                     telemetry.addData("Encoder Count", leftmotor.getCurrentPosition());
                    telemetry.update();
                }
                ...
                encReset();
                leftmotor.setPower(.18);
                rightmotor.setPower(.28);
                while (Math.abs(leftmotor.getCurrentPosition()) < 1100) {
                    telemetry.addData("Encoder Count", leftmotor.getCurrentPosition());
                    telemetry.update();
                }
                    **/
                ...
                while (Math.abs(leftfront.getCurrentPosition()) <1700) {
                    telemetry.addData("Encoder Count", leftfront.getCurrentPosition());
                    telemetry.update();
                    sleep(1000);}}}}}
/*
                ...
                while (Math.abs(leftmotor.getCurrentPosition()) < 100) {
                  ...
                  /*  while (angles.firstAngle < 160 && opModeIsActive()) {
                ...
                while (Math.abs(leftmotor.getCurrentPosition()) < 450) {
                    telemetry.addData("Encoder Count", leftmotor.getCurrentPosition());
                    telemetry.update();
                }
                leftmotor.setPower(0);
                ...
                leftmotor.setPower(-0.20);
                rightmotor.setPower(-0.20);
                while (Math.abs(leftmotor.getCurrentPosition()) < 1130) {
                    telemetry.addData("Encoder Count", leftmotor.getCurrentPosition());
                    telemetry.update();
                }
                leftmotor.setPower(0);
