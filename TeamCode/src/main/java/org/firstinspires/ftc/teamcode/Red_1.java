 ...
 */
    ...
    @Autonomous(name="State_Red_1", group ="Autonomous")
@Disabled
  ...
  //  private DcMotor lights;
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // Range = hardwareMap.get(ModernRoboticsI2cRangeSensor.class, "sensor_range");
        ...
        telemetry.addData("version: ", "1.1.5 | Left side edition!");
        telemetry.update();
        waitForStart();
...
*/
                ...
                while (Math.abs(leftFront.getCurrentPosition()) < 850 && opModeIsActive()) {
                ...
                leftFront.setPower(.25);
                leftRear.setPower(.25);
                rightFront.setPower(.38);
                rightRear.setPower(.38);
                sleep(1500);
